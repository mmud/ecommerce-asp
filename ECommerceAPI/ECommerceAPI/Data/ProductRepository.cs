...
namespace ECommerceAPI.Data
{
    public class ProductRepository
    {
        ...
        {
            var query = "SELECT ProductId, Name, Price, Quantity, Description, ImagePath,AdditionalImage1,AdditionalImage2,AdditionalImage3, IsDeleted FROM Products WHERE ProductId = @ProductId AND IsDeleted = 0";
